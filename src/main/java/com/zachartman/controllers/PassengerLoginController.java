...
public class PassengerLoginController {
    ...
    public void handleSignupButton(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zachartman/views/signup_page.fxml"));
            Parent root = loader.load();
    ...
    public void handleAdministratorButton(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zachartman/views/admin_signin_page.fxml"));
            Parent root = loader.load();
