...
public class AdminDashboardController {
    ...
    public void handleAddAirportButton(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zachartman/views/add_airport_page.fxml"));
            Parent root = loader.load();
    ...
    public void handleAddFlightButton(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zachartman/views/add_flight_page.fxml"));
            Parent root = loader.load();
    ...
    public void handleRemoveFlightButton(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zachartman/views/remove_flight_page.fxml"));
            Parent root = loader.load();
    ...
    public void handleAddPassengerToFlightButton(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zachartman/views/add_passenger_to_flight_page.fxml"));
            Parent root = loader.load();
    ...
    public void handleRemovePassengerFromFlightButton(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zachartman/views/remove_passenger_from_flight_page.fxml"));
            Parent root = loader.load();
